...
# H2: individual activism turnout (%)
# BASE excluded from H2 (no activism in baseline)
...
if __name__ == "__main__":
    ...
    # --- Omnibus Cohen's f ---
    print(f"{'Scenario':<30} {'f (H1)':<12} {'Benchmark':<12} {'f (H2)':<12} {'Benchmark'}")
    print("-" * 80)
